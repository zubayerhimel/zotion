...
export const getById = query({
  ...
  handler: async (ctx, args) => {
    ...
    // this check is only for published documents
    ...
    const userId = identity.subject;
    if (document.userId !== userId) throw new Error('Unauthorized user!');
...
export const update = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (existingDocument.userId !== userId) throw new Error('Unauthorized user!');
